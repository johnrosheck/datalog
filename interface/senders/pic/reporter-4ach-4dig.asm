; Source File : reporter-4ach-4dig.asm
; Begun :  October 19, 2012
...
; *
;
;  The commands have the structure:
;  'L' - the letter L
...
;	call	send_string
	...
	movwf	cmd_ch3
	movlw	0x04
	movwf	adc_ch		; start at channel four
...
main_loop
	...
	movlw	0x04
	movwf	adc_ch		; restart at channel four
;	goto	dump_data
...
dump_data
	...
	movf	cntl,W
	call	send_hex_byte
	; now send top four channel values
	movlw	0x4
	movwf	adc_tmp
	bcf	STATUS,IRP
	movlw	adc_store+8
...
make_real
	...
	andlw	0x28		; leave some bits alone
